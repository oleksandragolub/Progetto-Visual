...
# PATHS
# =========================
MODEL_PATH = r"F:\psd\file visual\task1\Nuova cartella\Nuova cartella\pesi\best_model_for_task1-db-original-resnet-baseline.pth"
TEST_PATH  = r"F:\psd\file visual\visual_exam_dataset\visual_dataset\test"  # oppure test_degradato
...
class SEResNet(nn.Module):
    """ResNet18 con BasicBlock SE compatibile con chiavi tipo layer1.0.se.fc..."""
...
def build_model_from_filename(model_path: str, num_classes: int):
    ...
    if "efficientnet" in name:
        # b0 nel tuo caso (se hai b1/b2, cambia qui)
    ...
    if "se-resnet" in name or "sp-se-resnet" in name or "dp-se-resnet" in name:
        # reduction=16 come nel tuo Config
